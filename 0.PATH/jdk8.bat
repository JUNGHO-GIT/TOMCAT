...
set "JAVA_HOME=C:\JUNGHO\1.Language\1.JAVA\1.jdk1.8"
set "JAVA_HOME2=C:\JUNGHO\1.Language\1.JAVA\2.jdk11"
set "JAVA_HOME3=C:\JUNGHO\1.Language\1.JAVA\3.jdk17"
...
set "JAVA_TOOLS_OPTIONS=-Xmx16g -XX:+AggressiveOpts -XX:+CompactStrings -XX:+DisableExplicitGC -XX:+EnableDynamicAgentLoading -XX:+GlobalLockReservation -XX:+IdleTuningCompactOnIdle -XX:+JITServerUseAOTCache -XX:+PortableSharedCache -XX:+TransparentHugePage -XX:+UseParallelGC -XX:+UseCompressedOops -XX:+UseContainerSupport -XX:+UseJITServer -XX:+UseAdaptiveSizePolicy -XX:+UseStringDeduplication -XX:+UseCompressedClassPointers -XX:+UseFastAccessorMethods -XX:+UseFastEmptyMethods -XX:+UseFastUnorderedTimeStamps -XX:+OptimizeStringConcat -XX:+UnlockExperimentalVMOptions -Xjit:EnableOSR -Xgc:ConcurrentScavenge -Xgc:DynamicBreadthFirstScanOrdering --add-opens=java.base/java.io=ALL-UNNAMED --add-opens=java.base/java.lang=ALL-UNNAMED -Djava.compiler=j9jit29"
set "CATALINA_OPTS=-Xmx16g -XX:+AggressiveOpts -XX:+CompactStrings -XX:+DisableExplicitGC -XX:+EnableDynamicAgentLoading -XX:+GlobalLockReservation -XX:+IdleTuningCompactOnIdle -XX:+JITServerUseAOTCache -XX:+PortableSharedCache -XX:+TransparentHugePage -XX:+UseParallelGC -XX:+UseCompressedOops -XX:+UseContainerSupport -XX:+UseJITServer -XX:+UseAdaptiveSizePolicy -XX:+UseStringDeduplication -XX:+UseCompressedClassPointers -XX:+UseFastAccessorMethods -XX:+UseFastEmptyMethods -XX:+UseFastUnorderedTimeStamps -XX:+OptimizeStringConcat -XX:+UnlockExperimentalVMOptions -Xjit:EnableOSR -Xgc:ConcurrentScavenge -Xgc:DynamicBreadthFirstScanOrdering --add-opens=java.base/java.io=ALL-UNNAMED --add-opens=java.base/java.lang=ALL-UNNAMED -Djava.compiler=j9jit29"
